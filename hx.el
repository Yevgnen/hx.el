...
(defvar hx-normal-mode-map
  (let ((keymap (make-sparse-keymap)))
    ...
    ;; Window
    (define-key keymap (kbd "C-w w") #'other-window)
    (define-key keymap (kbd "C-w C-w") #'other-window)
    (define-key keymap (kbd "C-w v") #'split-window-vertically)
    (define-key keymap (kbd "C-w C-v") #'split-window-vertically)
    (define-key keymap (kbd "C-w s") #'split-window-horizontally)
    (define-key keymap (kbd "C-w C-s") #'split-window-horizontally)
    (define-key keymap (kbd "C-w f") #'find-file-other-window)
    (define-key keymap (kbd "C-w F") #'find-file-other-window)
    (define-key keymap (kbd "C-w h") #'windmove-left)
    (define-key keymap (kbd "C-w C-h") #'windmove-left)
    (define-key keymap (kbd "C-w j") #'windmove-down)
    (define-key keymap (kbd "C-w C-j") #'windmove-down)
    (define-key keymap (kbd "C-w k") #'windmove-up)
    (define-key keymap (kbd "C-w C-k") #'windmove-up)
    (define-key keymap (kbd "C-w l") #'windmove-right)
    (define-key keymap (kbd "C-w C-l") #'windmove-right)
    (define-key keymap (kbd "C-w q") #'delete-window)
    (define-key keymap (kbd "C-w C-q") #'delete-window)
    (define-key keymap (kbd "C-w o") #'delete-other-windows)
    (define-key keymap (kbd "C-w C-o") #'delete-other-windows)
    ;; Space mode
